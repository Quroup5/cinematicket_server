...
class Cinema(Base):
    ...
    showtime_list = relationship("ShowTime", secondary=cinema_showtime, back_populates="cinema_list")
...
class ShowTime(Base):
    ...
    cinema_list = relationship("Cinema", secondary=cinema_showtime, back_populates="showtime_list")
...
class Seat(Base):
    __tablename__ = "seats"
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    showtime_list= relationship("ShowTime", secondary=seat_showtime, back_populates="seat_list")
